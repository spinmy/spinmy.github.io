        ...
        class playGame extends Phaser.Scene {
            ...
            spinWheel() {
                if (this.canSpin) {
                    ...
                    // Calculate the center angle of the prize slice
                    var centerAngle = 360 * rounds + (360 / gameOptions.slices) * (prizeSlice + 0.5);
                    var targetDegrees = 5 * 360 + centerAngle;
                    
                    // Ensure that the wheel stops in the center of a slice
                    if (targetDegrees - totalDegrees < 180) {
                        targetDegrees += 360;
                    }
                    ...
                    this.tweens.add({
                        ...
                        onComplete: function (tween) {
                            ...
                            // Add any code for displaying the "pyro" effect here
                        }
                    });
                }
            }
